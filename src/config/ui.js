...
export const secondaryCtaLabel = 'Book a call';
...
export const licenseLabel = 'License agreement';
export const shortLicenseLabel = 'License';
export const privacyLabel = 'Privacy policy';
export const shortPrivacyLabel = 'Privacy';
export const attributionLabel = '© Agent First Inc.';
export const shortAttributionLabel = '© Agent First';
...
export const urlPlaceholder = '$TARGET_URL';
export const examplePlaceholder = 'https://example.com/';
...
export const calPath = 'oldestlivingboy/a1';
...
export const smIconDimension = '24px';
...
export const subheadingFontSize = { base: 'md', sm: '22px !important', lg: '2xl !important' };
export const altSubheadingFontSize = { base: '15px', sm: '22px !important', lg: '2xl !important' };
...
export const teammateMargin = { base: 2, lg: 48 };
