...
export const showLabel = 'Show API token';
export const hideLabel = 'Hide API token';
export const copyLabel = 'Copy API token';
...
export const copiedMessage = 'API token copied to clipboard';
